<?php /* Smarty version 2.6.25, created on 2020-06-09 01:51:15
         compiled from layer_banedit.tpl */ ?>
<?php require_once(SMARTY_CORE_DIR . 'core.load_plugins.php');
smarty_core_load_plugins(array('plugins' => array(array('modifier', 'lang', 'layer_banedit.tpl', 4, false),array('modifier', 'date_format', 'layer_banedit.tpl', 70, false),array('modifier', 'bbcode2html', 'layer_banedit.tpl', 72, false),array('function', 'html_options', 'layer_banedit.tpl', 27, false),)), $this); ?>
...
" />
						...
						<input type="hidden" name="ban_length_old" value="<?php echo $this->_tpl_vars['ban_detail']['ban_length']; ?>
" />
						<input type="hidden" name="ban_created" value="<?php echo $this->_tpl_vars['ban_detail']['ban_created']; ?>
" />
...
:</b></td>
							<td><input type="test" size="40" id="id0" name="player_nick" value="<?php echo $this->_tpl_vars['ban_detail']['player_nick']; ?>
" <?php if ($this->_tpl_vars['ban_detail']['ban_length'] == -1): ?>disabled<?php endif; ?> /></td>
						</tr>
...
:</b></td>
							<td><input type="test" size="40" id="id1" name="player_id" value="<?php echo $this->_tpl_vars['ban_detail']['player_id']; ?>
" <?php if ($this->_tpl_vars['ban_detail']['ban_length'] == -1): ?>disabled<?php endif; ?> /></td>
						</tr>
...
:</b></td>
							<td><?php if ($this->_supers['session']['ip_view'] == 'yes'): ?>
								<input type="test" size="40" id="id2" name="player_ip" value="<?php echo $this->_tpl_vars['ban_detail']['player_ip']; ?>
" <?php if ($this->_tpl_vars['ban_detail']['ban_length'] == -1): ?>disabled<?php endif; ?> /><?php else: ?><i><?php echo ((is_array($_tmp='_HIDDEN')) ? $this->_run_mod_handler('lang', true, $_tmp) : smarty_modifier_lang($_tmp)); ?>
</i>
								<?php endif; ?>
							</td>
						</tr>
...
:</b></td>
							<td><select id="id3" name="ban_type" width="200" <?php if ($this->_tpl_vars['ban_detail']['ban_length'] == -1): ?>disabled<?php endif; ?>><?php echo smarty_function_html_options(array('output' => $this->_tpl_vars['type_output'],'values' => $this->_tpl_vars['type_values'],'selected' => $this->_tpl_vars['ban_detail']['ban_type']), $this);?>
</select></td>
						</tr>
...
:</b></td>
							<td><input type="test" size="40" id="id4" name="ban_reason" value="<?php echo $this->_tpl_vars['ban_detail']['ban_reason']; ?>
" <?php if ($this->_tpl_vars['ban_detail']['ban_length'] == -1): ?>disabled<?php endif; ?>/></td>
						</tr>
...
:</b></td>
							<td><?php if ($this->_supers['session']['bans_unban'] == 'yes' || ( $this->_supers['session']['bans_unban'] == 'own' && $this->_supers['session']['uname'] == $this->_tpl_vars['ban_detail']['username'] )): ?>
									<input type="test" size="10" id="id5" name="ban_length" value="<?php if ($this->_tpl_vars['ban_detail']['ban_length'] != -1): ?><?php echo $this->_tpl_vars['ban_detail']['ban_length']; ?>
<?php endif; ?>"  <?php if ($this->_tpl_vars['ban_detail']['ban_length'] == -1): ?>disabled<?php endif; ?>/> <?php echo ((is_array($_tmp='_MINS')) ? $this->_run_mod_handler('lang', true, $_tmp) : smarty_modifier_lang($_tmp)); ?>
...
" /></div>
					...
					<?php if ($this->_tpl_vars['ban_details_edits']): ?>
					<br />
					<table width="100%" cellspacing="0" border="1">
						...
						<?php $_from = $this->_tpl_vars['ban_details_edits']; if (!is_array($_from) && !is_object($_from)) { settype($_from, 'array'); }if (count($_from)):
    foreach ($_from as $this->_tpl_vars['ban_details_edits']):
?>
						<tr class="settings_line">
							<td nowrap><?php echo ((is_array($_tmp=$this->_tpl_vars['ban_details_edits']['edit_time'])) ? $this->_run_mod_handler('date_format', true, $_tmp, "%Y-%m-%d") : smarty_modifier_date_format($_tmp, "%Y-%m-%d")); ?>
</td>
							<td nowrap><?php echo $this->_tpl_vars['ban_details_edits']['admin_nick']; ?>
</td>
							<td><?php echo ((is_array($_tmp=$this->_tpl_vars['ban_details_edits']['edit_reason'])) ? $this->_run_mod_handler('bbcode2html', true, $_tmp) : smarty_modifier_bbcode2html($_tmp)); ?>
</td>
						</tr>
